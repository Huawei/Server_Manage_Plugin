...
class BMCRedfishManagement(base.ManagementInterface):
    ...
    def __init__(self):
        ...
        """
        super(BMCRedfishManagement, self).__init__()
        if not sushy:
    ...
    def set_boot_device(self, task, device, persistent=False):
        ...
        :raises: BMCRedfishError on an error from the Sushy library
        """
        ...
        try:
            ...
            LOG.error(error_msg)
            raise exception.BMCRedfishError(error=error_msg)
