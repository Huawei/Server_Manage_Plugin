...
if [ "$2" = "-v2c" ]; then	snmpset $2 $3 $1 1.3.6.1.4.1.2011.2.82.1.82.4.$9.32.0 s "${10}"
elif [ "$2" = "-v3" ]; then	snmpset $2 $4 -l authPriv $5 $6 $7 $8 $1 1.3.6.1.4.1.2011.2.82.1.82.4.$9.32.0 s "${10}"
fi
